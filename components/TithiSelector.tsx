...
const TithiSelector: React.FC<TithiSelectorProps> = ({ currentAngle, onSelect }) => {
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-900/60 backdrop-blur-sm border border-slate-700/40 rounded-xl p-3 shadow-lg">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 border-b border-slate-700/50 pb-1">
          ...
          <h3 className="text-xs font-bold text-indigo-200 uppercase tracking-wider">Shukla Paksha</h3>
        </div>
        ...
        <div className="grid grid-cols-5 gap-1.5">
          {shuklaTithis.map((t) => (
            <button
              ...
              className={`px-1 py-1 rounded-md text-[9px] font-medium transition-all border truncate ${
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 border-b border-slate-700/50 pb-1">
          ...
          <h3 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Krishna Paksha</h3>
        </div>
